...
list alloc_mlist_r(void (*free_func) (void *), void (*dump_func) (FILE *, const void *), size_t size)
{
...
void dump_mlist(FILE *fp, list l, size_t size)
{
	element e;
	unsigned i;
...
static void free_melement(list l, void (*free_func) (void *))
{
	element e;
	element next;
...
void free_mlist_r(list l, size_t size)
{
	size_t i;
...
list alloc_list_r(void (*free_func) (void *), void (*dump_func) (FILE *fp, const void *))
{
...
static inline void __list_add(list l, element e)
{
	e->prev = l->tail;
	e->next = NULL;
...
void list_add_r(list l, void *data)
{
...
void list_add_head_r(list l, void *data)
{
	element e = alloc_element();
...
static inline void __list_remove(list l, const element e)
{
	if (e->prev)
		e->prev->next = e->next;
	else
...
void list_extract(list l, const element e)
{
	__list_remove(l, e);
}

void list_del_r(list l, const void *data)
{
	element e;
...
void free_list_data_r(list l, const void *data)
{
	element e;
