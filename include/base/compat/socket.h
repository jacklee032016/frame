 ...
 */
#ifndef __BASE_COMPAT_SOCKET_H__
#define __BASE_COMPAT_SOCKET_H__
...
#if defined(BASE_HAS_WS2TCPIP_H) && BASE_HAS_WS2TCPIP_H != 0
#   include <ws2tcpip.h>
#endif
 ...
 */
#if defined(_MSC_VER) && defined(BASE_HAS_IPV6) && BASE_HAS_IPV6!=0
#   ifndef s_addr
...
#   define BASE_SOCK_HAS_GETADDRINFO  1
#endif	/* _MSC_VER */

#if defined(BASE_HAS_SYS_TYPES_H) && BASE_HAS_SYS_TYPES_H != 0
#  include <sys/types.h>
#endif

#if defined(BASE_HAS_SYS_SOCKET_H) && BASE_HAS_SYS_SOCKET_H != 0
#  include <sys/socket.h>
#endif

#if defined(BASE_HAS_LINUX_SOCKET_H) && BASE_HAS_LINUX_SOCKET_H != 0
#  include <linux/socket.h>
#endif

#if defined(BASE_HAS_SYS_SELECT_H) && BASE_HAS_SYS_SELECT_H != 0
#  include <sys/select.h>
#endif

#if defined(BASE_HAS_NETINET_IN_H) && BASE_HAS_NETINET_IN_H != 0
#  include <netinet/in.h>
#endif

#if defined(BASE_HAS_NETINET_IN_SYSTM_H) && BASE_HAS_NETINET_IN_SYSTM_H != 0
/* Required to include netinet/ip.h in FreeBSD 7.0 */
#  include <netinet/in_systm.h>
#endif

#if defined(BASE_HAS_NETINET_IP_H) && BASE_HAS_NETINET_IP_H != 0
/* To pull in IPTOS_* constants */
#  include <netinet/ip.h>
#endif

#if defined(BASE_HAS_NETINET_TCP_H) && BASE_HAS_NETINET_TCP_H != 0
...
#if defined(BASE_HAS_NET_IF_H) && BASE_HAS_NET_IF_H != 0
/* For interface enumeration in ip_helper */
#   include <net/if.h>
#endif

#if defined(BASE_HAS_IFADDRS_H) && BASE_HAS_IFADDRS_H != 0
/* Interface enum with getifaddrs() which works with IPv6 */
#   include <ifaddrs.h>
#endif

#if defined(BASE_HAS_ARPA_INET_H) && BASE_HAS_ARPA_INET_H != 0
#  include <arpa/inet.h>
#endif

#if defined(BASE_HAS_SYS_IOCTL_H) && BASE_HAS_SYS_IOCTL_H != 0
...
#if defined(BASE_HAS_NETDB_H) && BASE_HAS_NETDB_H != 0
#  include <netdb.h>
#endif
...
#if defined(BASE_HAS_SYS_FILIO_H) && BASE_HAS_SYS_FILIO_H != 0
#   include <sys/filio.h>
#endif

#if defined(BASE_HAS_SYS_SOCKIO_H) && BASE_HAS_SYS_SOCKIO_H != 0
 ...
 * os_auto.h
 */
#if !defined(BASE_HAS_SOCKLEN_T) || BASE_HAS_SOCKLEN_T==0
 ...
 *
 *  To maintain compatibility between systems,  will automatically
 *  set this field before invoking native OS socket API, and it will
 *  always reset the field to zero before returning bsockaddr_in to
 *  application (such as in bgetsockname() and brecvfrom()).
 *
...
#   define BASE_SOCKADDR_SET_LEN(addr,len) (((baddr_hdr*)(addr))->sa_zero_len=(len))
#   define BASE_SOCKADDR_RESET_LEN(addr)   (((baddr_hdr*)(addr))->sa_zero_len=0)
#else
#   define BASE_SOCKADDR_SET_LEN(addr,len) 
#   define BASE_SOCKADDR_RESET_LEN(addr)
#endif

#endif	/* __BASE_COMPAT_SOCKET_H__ */
