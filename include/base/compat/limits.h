 ...
 */
#ifndef __BASE_COMPAT_LIMITS_H__
#define __BASE_COMPAT_LIMITS_H__
...
#  pragma message("limits.h is not found or not supported. LONG_MIN and "\
		 ...
		 "compats/limits.h and overridable in config_site.h")
#  else
#  warning "limits.h is not found or not supported. LONG_MIN and LONG_MAX " \
           "will be defined by the library in compats/limits.h and "\
...
#endif  /* __BASE_COMPAT_LIMITS_H__ */
