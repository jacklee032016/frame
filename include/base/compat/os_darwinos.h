 ...
 */
#ifndef __BASE_COMPAT_OS_DARWINOS_H__
#define __BASE_COMPAT_OS_DARWINOS_H__
...
#define BASE_HAS_MALLOC_H		    0
#define BASE_HAS_NETDB_H		    1
#define BASE_HAS_NETINET_IN_H	    1
#define BASE_HAS_NETINET_TCP_H	    1
 ...
 * the value of FD_SETSIZE that we declare in baseConfig.h is
 * different than the value in /usr/include/sys/types.h.
 *
 * This changes the default value for Darwin.
 */
#define BASE_IOQUEUE_MAX_HANDLES		1024
...
#endif	/* __BASE_COMPAT_OS_DARWINOS_H__ */
