 ...
 *
 * #define BASE_CONFIG_NOKIA_APS_DIRECT
 *   Use this macro to activate the APS-Direct feature. Please see
 *   http://trac.extsip.org/repos/wiki/Nokia_APS_VAS_Direct for more 
 *   info.
 *
 * #define BASE_CONFIG_WIN32_WMME_DIRECT
 ...
 */
    ...
    #define BASE_HAS_FLOATING_POINT		0
     ...
     * be set to 3 or 4 so extsua-lib will apply small filter resampling.
     */
     ...
     * set to 4 to make sure extsua instantiates resampler with small filter.
     */
 ...
 */
     ...
     * to log the packet.
     */
    #define BASE_LOG_MAX_SIZE			(PJSIP_MAX_PKT_LEN+500)

    /* Since we don't have threads, log buffer can use static buffer
     * rather than stack
     */
    #define BASE_LOG_USE_STACK_BUFFER		0
 ...
 * Nokia S60 target
 *
 * Please see http://trac.extsip.org/repos/wiki/Nokia_APS_VAS_Direct
 */
#ifdef BASE_CONFIG_NOKIA_APS_DIRECT
 ...
 * Please see http://trac.extsip.org/repos/wiki/Nokia_APS_VAS_Direct
 */
#ifdef BASE_CONFIG_NOKIA_VAS_DIRECT
 ...
 */
#ifdef BASE_CONFIG_WIN32_WMME_DIRECT
 ...
 */
#if BASE_CONFIG_IPHONE
    /*
     *  settings.
     */

    /* Both armv6 and armv7 has FP hardware support.
     * See https://trac.extsip.org/repos/ticket/1589 for more info
     */
 ...
 * BB10
 */
#if defined(BASE_CONFIG_BB10) && BASE_CONFIG_BB10
 ...
 * Minimum size
 */
#ifdef BASE_CONFIG_MINIMAL_SIZE

#   undef BASE_OS_HAS_CHECK_STACK
#   define BASE_OS_HAS_CHECK_STACK	0
#   define BASE_LOG_MAX_LEVEL		0
#   define BASE_ENABLE_EXTRA_CHECK	0
#   define BASE_HAS_ERROR_STRING		0
#   undef BASE_IOQUEUE_MAX_HANDLES
/* Putting max handles to lower than 32 will make bfd_set_t size smaller
 * than native fdset_t and will trigger assertion on sock_select.c.
 */
#   define BASE_IOQUEUE_MAX_HANDLES	32
#   define BASE_CRC32_HAS_TABLES		0
...
#elif defined(BASE_CONFIG_MAXIMUM_SPEED)
#   define BASE_SCANNER_USE_BITWISE	0
#   undef BASE_OS_HAS_CHECK_STACK
#   define BASE_OS_HAS_CHECK_STACK	0
#   define BASE_LOG_MAX_LEVEL		3
#   define BASE_ENABLE_EXTRA_CHECK	0
#   define BASE_IOQUEUE_MAX_HANDLES	5000
